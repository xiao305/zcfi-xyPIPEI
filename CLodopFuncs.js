(function (win) {
        var CLODOP = {
        strWebPageID:"7BCAAAB",strTaskID:"",strHostURI:"https://localhost.lodop.net:8443",
                ...
                function() {
                        ...
                        try {
                                if (!this.webskt || this.webskt.readyState==3) {
                                        ...
                                        this.webskt=new WebSocket('wss://localhost.lodop.net:8443/c_webskt/');
